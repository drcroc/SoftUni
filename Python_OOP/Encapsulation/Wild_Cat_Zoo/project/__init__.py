...
class Tests(unittest.TestCase):
    ...
    def test_zoo_init(self):
        ...
        self.assertEqual(z._Zoo.__animal_capacity, 6)
        self.assertEqual(z._Zoo__workers_capacity, 10)
        self.assertEqual(z._Zoo.__budget, 1500)
    ...
    def test_zoo_add_animal_success(self):
        ...
        self.assertEqual(z._Zoo.__budget, 500)
    ...
    def test_zoo_hire_worker_success(self):
        ...
        self.assertEqual(z._Zoo.__workers_capacity, 1)
    ...
    def test_zoo_hire_worker_no_space(self):
        ...
        self.assertEqual(z._Zoo.__workers_capacity, 0)
    ...
    def test_zoo_pay_worker_success(self):
        ...
        res = z.pay_workers()
        self.assertEqual(z._Zoo.__budget, 1250)
